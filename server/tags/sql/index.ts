const getPostsWithTags = `
    select posts_with_tags.* FROM (  
        select
            ...
            row_to_json(posts_user.*) as posts_user_info,
        ...
        from posts
            ...
            LEFT JOIN users as posts_user on posts.author = users.id
            ...
            LEFT JOIN users as first_post_in_thread_user on first_post_in_thread.author = users.id
